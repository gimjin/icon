...
/**
  ...
  * @param {string} opt.svgDest - Directory for generated svg file.
...
module.exports = function (opt) {
  ...
  let options = Object.assign({
    ...
    template: '../templates/icon-symbol.hbs',
  ...
  let spriter = new SVGSprite({
    ...
    mode: {
      symbol: {
        dest: '',
        sprite: path.join(process.cwd(), options.svgDest, options.name + '.svg'),
        render: {
          js: {
